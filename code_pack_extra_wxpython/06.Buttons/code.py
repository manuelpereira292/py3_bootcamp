...
class Mywin(wx.Frame): 
   def __init__(self, parent, title): 
      super(Mywin, self).__init__(parent, title = title,size = (600,450))  
      panel = wx.Panel(self) 
      ...
      bmp = wx.Bitmap("new.png", wx.BITMAP_TYPE_PNG) 
      ...
      bmp1 = wx.Bitmap("open.png", wx.BITMAP_TYPE_PNG) 
      ...
      bmp2 = wx.Bitmap("save.png", wx.BITMAP_TYPE_PNG) 
